defmodule BbhWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: BbhWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BbhWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BbhWeb.Gettext, "errors", msg, opts)
    end
  end
