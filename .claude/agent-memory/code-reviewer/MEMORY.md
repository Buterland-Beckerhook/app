...
- [Verify the diff base first](feedback_verify_diff_base.md) — run `git log HEAD..main` before attributing hunks; local main sits ahead and inverts its own commits into `git diff main`
